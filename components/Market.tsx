...
export default function IrregularImageGallery() {
  ...
  const images = [
    ...
    { src: "/images/market/pizza_girl.png", alt: "AI with 237 Pizza" },
    { src: "/images/market/pizza_girl1.png", alt: "AI with 237 Pizza" },
    { src: "/images/market/pizza_girl2.png", alt: "AI with 237 Pizza" },
